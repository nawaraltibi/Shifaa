...
import 'package:shifaa/features/home/presentation/views/widgets/home_actions_helper.dart';
            ...
            children: [
              Expanded(
                child: ElevatedButton(
                  onPressed: () {
                    showRescheduleSheetForAppointment(context, appointment.id, appointment.doctorId);
                  },
              ...
              Expanded(
                child: ElevatedButton(
                  onPressed: () {
                    showCancelConfirmationDialogForAppointment(context, appointment.id);
                  },
                  style: ElevatedButton.styleFrom(
      ...
      children: [
        ...
        Column(
          ...
          children: [
            Text(
              title,
              style: AppTextStyles.regular10.copyWith(color: Colors.white.withOpacity(0.8)),
            ),
            Text(
              subtitle,
              style: AppTextStyles.medium12.copyWith(color: Colors.white),
